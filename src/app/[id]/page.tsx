            ...
            <CardHeader className="p-8">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-muted-foreground">Shop C3A Eastwood Shopping Centre</p>
                  <p className="text-sm text-muted-foreground">160 Rowe Street, EASTWOOD NSW 2122</p>
                  ...
                  <p className="text-sm text-muted-foreground">0450779688, 0414640101</p>
                </div>
              </div>
